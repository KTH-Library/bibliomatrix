...
# 	title = "HTML Read more ...",
# 	text = sprintf("<a href='%s' target='_blank'>Read more ...</a>", 
#     "https://kth-library.github.io/abm/ABM_guide.pdf"),
# 	html = TRUE
# )
...
### **Field normalized citationsm, fractionalized (3-year moving average)** {.no-padding .mobile}
