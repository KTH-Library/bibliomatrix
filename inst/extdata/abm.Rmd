...
if(isTRUE(unit_level >= 0)){
  ...
  cat("<p><b>Bibliometric results for individual researchers should always be interpreted with caution. </b></br/>
      This is because bibliometric indicators work best at an aggregated level, and at the individual level 
      ...
      individuals also makes indicator averages extremely unreliable. </p>")
