...
wospubstext <- paste("<p>Citation based indicators are based on", round(wospubs, 1), "publications.")
if(wospubs < 10)
  wospubstext <- paste0(wospubstext, " <b>That is very small, and makes indicators unreliable.</b>")
wospubstext <- paste0(wospubstext, "</p>")
cat(wospubstext)

coveragejudge <- ifelse(totcov >= 0.8, "good",
                        ifelse(totcov >= 0.65, "moderate",
                               ifelse(totcov >= 0.5, "poor", "bad")))

coveragetext <- glue::glue("<p>Web of Science coverage is <b>{coveragejudge}</b>, ", 100*round(totcov, 3), "%. ")
if(coveragejudge == "moderate") coveragetext <- paste0(coveragetext, "<b>Proceed with caution.</b>")
if(coveragejudge == "poor") coveragetext <- paste0(coveragetext, "<b>This is poor, indicators should be treated with extreme caution.</b>")
if(coveragejudge == "bad") coveragetext <- paste0(coveragetext, "<b>This is very poor, indicators can not be trusted.</b>")
coveragetext <- paste0(coveragetext, "</p>")
cat(coveragetext)
```
...
The bibliometric indicators referred are based on publications registered in DiVA and published 2012 to 2018. Only publications which have been affiliated to KTH are included. This yields that publications written by a researcher before she/he was employed at KTH, and that are not affiliated to KTH, are not included in the statistics.
