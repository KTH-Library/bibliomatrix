...
```{r, fig.height=10, fig.width=3.75}
...
`r if(params$embed_data == FALSE) {"\\begin{comment}"} else {NULL}`
### Publication list
```{r, echo=FALSE}
abm_ui_datatable_publications(data, "", "")
```
`r if(params$embed_data == FALSE) {"\\end{comment}"} else {NULL}`
