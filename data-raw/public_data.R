...
# TODO: sync/upload to remote db too
db_sync_table("unit_stats", con_src = con_bib_sqlite(), con_dest = con_bib_mssql())
db_sync_table("researchers", con_src = con_bib_sqlite(), con_dest = con_bib_mssql())
db_sync_table("divisions", con_src = con_bib_sqlite(), con_dest = con_bib_mssql())
