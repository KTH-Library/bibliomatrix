...
coveragetext <- paste0("<p>Web of Science coverage is ", 100*round(totcov, 3), "%. ")
if(totcov >= 0.8) coveragetext <- paste0(coveragetext, "This is OK!</p>")
if(totcov < 0.8 && totcov >= 0.6) coveragetext <- paste0(coveragetext, "<b>This is bad, proceed with caution!</b></p>")
if(totcov < 0.6) coveragetext <- paste0(coveragetext, "<b>This is very bad, indicators can not be trusted!</b></p>")
cat(coveragetext)
```
