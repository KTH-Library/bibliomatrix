...
### Citation Impact
<div style='display:flex; flex-direction:row; justify-content:space-evenly; align-items:left;'>
<div>
#### **Citations, open window**
<style type="text/css">
div.dt-buttons {
  position:relative;
  float:right;
...
```{r, fig.height=6, fig.width = 6, out.width = "40%"}
...
#### **Notes** [<i class="fa fa-info-circle" aria-hidden="true"></i> more...](`r STATIC`/ABM_guide.pdf){target="_blank" style="position:relative; float:top;"}

```{r, fig.height = 4, fig.width = 6, echo=FALSE, results="asis", out.width = "40%"}
cat("insert some notes here (maybe we should make functions for these)")
```

```{r, fig.height = 4, fig.width = 6, out.width = "40%"}
