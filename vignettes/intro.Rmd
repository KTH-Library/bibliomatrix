...
#
# NOTE: Section below is giving check/build_vignettes error, probably due to sqlite
...
```{r, fig.align='left'}
# NOTE: This section is giving check/build_vignettes error, probably due to LDAP-user etc
