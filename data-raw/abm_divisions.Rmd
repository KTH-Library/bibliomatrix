...
linkify <- function(x, y)
  sprintf("<a href='%s' target='_blank'>%s</a>", paste0("/ui/division/", sapply(y, function(z) URLencode(z, reserved = TRUE))), x)
...
fn <- abm_graph_divisions(
  base_url = "/visual/dash/", 
  link_encoder = function(x) URLencode(x, reserved = TRUE),
  use_size = TRUE
) 
