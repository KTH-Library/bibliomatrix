...
unit_members <- abm_researchers(unit_code, con = con_bib())#unit_staff(unit_slug=unit_code)
...
researchers <- 
  ...
  filter(slug == unit_code) %>% select(Username = username, Title = `title.en`) %>% collect()
