...
if (unit_code %in% unit_info()$slug) {
  unit_label <- bibliomatrix::unit_info() %>% filter(slug == params$unit_code) %>% pull(unit_long_en)
} else {
