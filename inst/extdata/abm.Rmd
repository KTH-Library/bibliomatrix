...
params:
  unit_code: "882653" #!r bibliomatrix:::abm_config()$default_unit
  is_employee: FALSE
...
if(isTRUE(unit_level >= 0)){
  ...
  glue("<p>Overall Web of Science coverage for peer reviewed publications in this unit is",
       "{ifelse(totcov < 0.75, paste0(' ', coveragetext(totcov), ','), '')} {100*round(totcov, 3)}%.</p>")
...
if(isTRUE(unit_level >= 0)){
  ...
  cat("<b>Bibliometric results for individual researchers should always be treated with caution.</b>")
